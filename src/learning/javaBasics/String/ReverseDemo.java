package learning.javaBasics.String;
...
public class ReverseDemo {
	...
	public static void reverse2() {
		...
		// into bytes[]. - bytes is the smallest data type you can work with
	...
	// Java program to ReverseString using StringBuilder - FASTEST
	...
	public static void reverse6() {
		...
		while (li.hasNext())//li returns true if there are more element
			//when we use dynamic datastructures we use iterators
...
//			System.out.print(trial1[i]);
		...
		Object[] trial2 = trial1.toArray();//interesting
