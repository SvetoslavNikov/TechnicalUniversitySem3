package javaLectures.sorting;// sort: both select and insert sort
// demonstrate more about arrays and encapsulation


//OOP code, not with just static method. There is no point doing that in java just do it in c.
