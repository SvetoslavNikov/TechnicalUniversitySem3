...
public class InterfaceDemoMain {
	...
	public static void main(String[] args) {
		...
		//here it returns usually the classtype@adress of the object
		//but cus we have predefined the string method so it will returns something else

		System.out.println("Less (r1,r2): "+r1.less(r2));
	}
